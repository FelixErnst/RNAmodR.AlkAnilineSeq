...
Loading files
```{r}
gff <- system.file("extdata","example_AAS.gff3" ,package = "RNAmodR.Data")
fasta <- system.file("extdata","example_AAS.fasta" ,package = "RNAmodR.Data")
...
```{r}
msaas <- ModSetAlkAnilineSeq(files,fasta,gff)
```
